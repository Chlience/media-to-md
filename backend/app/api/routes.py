...
def _config_response(settings: Settings) -> ConfigResponse:
    ...
    return ConfigResponse(
        ...
        whisperx_openai_transcode_to_mp3=settings.whisperx_openai_transcode_to_mp3,
        whisperx_openai_mp3_bitrate=settings.whisperx_openai_mp3_bitrate,
...
def update_config(
    ...
    try:
        ...
        config_updates = {
            ...
            "whisperx_openai_transcode_to_mp3": update.whisperx_openai_transcode_to_mp3,
            "whisperx_openai_mp3_bitrate": update.whisperx_openai_mp3_bitrate,
