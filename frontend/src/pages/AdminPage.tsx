...
export function AdminPage() {
  ...
  const [modelCacheOnly, setModelCacheOnly] = useState(true);
              ...
              <div className="config-grid">
                <div className="config-card">
                  ...
                  <div className="config-inner">
                    <div className="form-grid">
                      <div className="field"><label className="label" htmlFor="cfg-model">默认模型</label><input id="cfg-model" className="input" value={model} onChange={(event) => setModel(event.target.value)} /></div>
                      <div className="field"><label className="label" htmlFor="cfg-model-dir">模型缓存目录</label><input id="cfg-model-dir" className="input mono" value={modelDir} onChange={(event) => setModelDir(event.target.value)} /></div>
                      <div className="field"><label className="label" htmlFor="cfg-device">Device</label><select id="cfg-device" className="select" value={whisperxArgValue('device', 'cuda')} onChange={(event) => setWhisperxArg('device', event.target.value)}><option value="cuda">cuda</option><option value="cpu">cpu</option></select></div>
                      <div className="field"><label className="label" htmlFor="cfg-compute-type">Compute type</label><select id="cfg-compute-type" className="select" value={whisperxArgValue('compute_type', 'float16')} onChange={(event) => setWhisperxArg('compute_type', event.target.value)}><option value="default">default</option><option value="float16">float16</option><option value="float32">float32</option><option value="int8">int8</option></select></div>
                      <div className="field"><label className="label" htmlFor="cfg-batch-size">Batch size</label><input id="cfg-batch-size" className="input mono" value={whisperxArgValue('batch_size', '16')} onChange={(event) => setWhisperxArg('batch_size', event.target.value)} /></div>
                      <div className="field"><label className="label" htmlFor="cfg-chunk-size">Chunk size</label><input id="cfg-chunk-size" className="input mono" value={whisperxArgValue('chunk_size', '')} placeholder="默认" onChange={(event) => setWhisperxArg('chunk_size', event.target.value)} /></div>
                      <div className="field"><label className="label" htmlFor="cfg-align-model">Align model</label><input id="cfg-align-model" className="input" value={whisperxArgValue('align_model', '')} placeholder="自动" onChange={(event) => setWhisperxArg('align_model', event.target.value)} /></div>
                      ...
                      <div className="field field-full"><label className="label" htmlFor="cfg-nltk">NLTK data dir</label><input id="cfg-nltk" className="input mono" value={nltkDataDir} onChange={(event) => setNltkDataDir(event.target.value)} /></div>
                    </div>
                  </div>
                </div>
